			...
			<div
				...
				<c:if test="${sessionScope.logout!= null}">
					<div class="alert alert-success text-center fs-4" role="alert">
						<i class="fa-solid fa-circle-check"></i> <span class="fw-bold">
							<c:out value="${sessionScope.logout.type} : "></c:out>
						</span><span><c:out value="${sessionScope.logout.message}"></c:out></span>
					</div>
