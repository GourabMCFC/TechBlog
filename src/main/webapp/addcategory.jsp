...
<html lang="en">
<head>
<title>TECHBLOG - ADD-CATEGORY PAGE</title>
<%@ include file="library.jsp"%>
<script type="text/javascript" src="./javascripts/addCategory.js"
	defer="defer"></script>
</head>
							...
							<form class="card-text p-3">
								<div class="form-floating mb-3">
									<input type="text" class="form-control text-bg-dark"
										name="cat_name" id="cat_name" placeholder="John Doe" /> <label
										for="cat_name" class="text-light">Category Name</label>
								</div>
								<div class="form-floating mb-3">
									<textarea class="form-control text-bg-dark"
										placeholder="Leave a comment here" id="cat_about"
										name="cat_about" style="height: 7rem; resize: none"></textarea>
									<label for="cat_about" class="text-light">Enter
